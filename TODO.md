...
- Latest deploy: GitHub Actions run `26837511117` succeeded at `2026-06-02T17:44:44Z`; Fly release v30, image `deployment-01KT4PZJN0CPMGY7V9XVW3D2DF`, code commit `bd1cbde`.
- Corpus: `819` verified entries, `114` symptom guides, `302` official sources, `934` generated indexable pages.
