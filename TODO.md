...
- Live verification passed: `/corpus-stats.json` reports `819`/`72`/`242`/`892`; `/sitemap.xml` reports `892` URLs; 10 representative new Dometic RM10 symptom routes returned HTTP `200`; production desktop/mobile Playwright smoke checked 10 RM10 symptom routes plus 4 lookup-result searches with `0` console/page/request failures and no checkout text.
