...
- Live verification pending for the RM10 fault-page batch after deploy. Last live verification remains RUA: `/corpus-stats.json` reports `802`/`62`/`209`/`865`; `/sitemap.xml` and 7 representative new Dometic RUA routes returned HTTP `200`; production desktop/mobile Playwright smoke checked 7 RUA routes plus 3 searches with `0` console/page/request failures and confirmed unsafe service terms are absent from owner-safe sections.
