...
- Current local batch verification pending push/deploy: legacy Norcold N-series focused RED/GREEN tests, `npm run validate:corpus`, and official source URL checks passed locally; full runtime/live verification still pending.
